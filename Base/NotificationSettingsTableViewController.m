...
// Subject to change. Organize by type, similar to iOS Settings
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *otherCells = [tableView dequeueReusableCellWithIdentifier:@"NotificationTypeCell"];
    
    if (indexPath.row == 0) {
        return settingsCell;
    }
    
    // Configure other cells here
    else {
        return otherCells;
    }
